    ...
    return (
        <div>
            <div className="bg-cyan-900 w-full h-60">
                <img className= "w-10 h-10 absolute right-6 top-71 cursor-pointer" src="/src/assets/a.png" onClick={handleClick}/>
                <div className="">
                    <div>
                    <img className=" border-4 border-white absolute top-50 left-10 w-50 h-50 rounded-full" src={ data?.profilePic} />
